...
const BingoItem = ({ text, drawed }: BingoItem) => {
  return (
    <div
      ...
      //   drawed ? "bg-green-400" : ""
      // }`}
      className={`bg-[antiquewhite] text-3xl rounded-xl aspect-square flex justify-center items-center ${
...
const BingoGrid = ({ drawedNumbers, maxNumber }: BingoGrid) => {
  ...
  return (
    ...
    <div className="h-full w-full grid grid-cols-10 auto-rows-min gap-4 text-center items-center justify-center">
