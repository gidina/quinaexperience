...
const Error = () => {
  ...
  <div className="text-center">
    ...
    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Pàgina no trobada</h1>
    <p className="mt-6 text-base leading-7 text-gray-600">Disculpa, no hem pogut trobat la pàgina que busques.</p>
